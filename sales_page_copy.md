# Japanese Calligraphy School - Sales Page Copy

## Hero Section

**Headline:** Your voice deserves more than a screen

**Subheadline:** Learn shodo—the ancient Japanese art of expressing what words alone cannot say

**Hero Image:** Brush creating a bold, flowing stroke in black ink
...
When was the last time you _created_ something with your hands?
...
Your handwriting is terrible, you tell yourself. You haven't drawn since elementary school. You're not artistic.

But that's the point.

---

## Section 2: The World We've Lost

We've traded presence for productivity.

Everything we create lives behind glass. Words we type, then delete, then retype. Digital everything. Nothing real. Nothing that breathes.
...
**Image:** Person scrolling on phone vs traditional calligraphy setup

---

## Section 3: What Really Keeps You Up
...
## Section 6: The Philosophy (The Mechanism)

**Background kanji watermark: 書道 (shodo)**
...
The philosophies that make it work:
...
This stroke, right now, will never exist again. You can't undo it. You can't edit it. It's perfect because it's yours.

**This is why shodo works when meditation apps don't.**
...
**Module 2: Basic Strokes & Characters**
...
**Module 5: Personal Style & Mastery Path**
...
**Background: Subtle watercolor wash**

### Bonus #1: Complete Materials Guide ($27 value)
...
## Section 9: Beautiful Work Image

**Image:** Finished shodo work—bold, flowing kanji on rice paper

---

## Section 10: Pricing & Guarantee
...
**The Bonuses:**
- Complete Materials Guide—exactly what to buy ($27)
- Start With What You Have—pen & paper method ($37)
- Kanji Meaning Library—100+ characters ($47)

**Total Value: $352**

**Your Investment Today:**

~~$97~~ **$47** for founding students

---

### Our 30-Day Guarantee

Take the full course. Practice for 30 days.

If you don't find shodo meditative, therapeutic, or rewarding—if it doesn't give you what we promised—email us. Full refund. No questions.
...
"I bought this thinking I'd learn 'Japanese handwriting.' What I got was meditation that actually works. My therapist asked what changed." — *Rachel T., Portland*
...
© 2025 Japanese Calligraphy School. All rights reserved.
...
## Color Palette (Japanese Minimalist - Ink Theme)

- **Background:** #F8F7F4 (warm white, like washi paper)
- **Sections:** #E9E7E3 (soft grey, like stone)
- **Text:** #1A1A1A (deep black, like sumi ink)
- **Accent:** #8B0000 (deep red, like hanko seal stamp)
- **Accent Hover:** #6B0000 (darker red)

## Typography

- **Body:** Default sans-serif (clean, readable)
- **Accents:** Noto Serif JP or similar (Japanese aesthetic)
- **Kanji watermarks:** Large, 0.03 opacity
